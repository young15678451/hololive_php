...
<body class="subpage">
	...
	<div class="container inner animate__animated animate__bounceInUp wow">
		...
		<span>
            <div class="back">
			<a href="chat.php">回留言主題</a></div>
		</span>
		<form role="form" action="mes.php?method=update&id=<?php echo $row["id"]?>" method="post">
            <div class="form-group">
                <label for="title">標題</label>
                <input type="text" class="form-control" id="title" maxlength="20" placeholder="標題" name="title" value="<?php echo $row["title"]?>">
            </div>
            <div class="form-group">
                <label for="name">暱稱</label>
                <input type="text" class="form-control" id="name" maxlength="20" placeholder="name" name="name" value="<?php echo $row["name"]?>">
            </div>
            <div class="form-group">
                <label for="content">留言內容</label>
                <textarea class="form-control" id="content" rows="3" maxlength="500" placeholder="內容" name="content" value="<?php echo $row["content"]?>"></textarea>
            </div>
