...
<body class="subpage">
    ...
    <div class="container inner animate__animated animate__bounceInUp wow">
		...
		<form role="form" name="myForm" action="mes.php?method=add" method="post">
            <div class="form-group">
                <label for="title">標題</label>
                <input type="text" class="form-control" id="title" maxlength="20" placeholder="title" name="title">
            </div>
            <div class="form-group">
                <label for="name">暱稱</label>
                <input type="text" class="form-control" id="name" maxlength="20" placeholder="name" name="name">
            </div>
            <div class="form-group">
                <label for="content">主題內容</label>
            ...
            <button type="button" class="btn" onClick="check_data()">新增</button>
